...
History retention defaults to 30 days (`RETENTION_DAYS`, maximum 365); export before expiry for a permanent archive. High-detail collection consumes more Tesla signals and D1 writes. D1 stores location samples, but this version does not automatically construct trips or display routes.
